<script lang="ts">
    ...
    import preistraegerKonzert from '/img/pictures/preistraegerkonzert_land.jpg'
...
<div class="relative h-[80vh]" id="cover">
    ...
    <div class="absolute inset-0 bg-cover bg-center" style="background-image: url({preistraegerKonzert})"></div>
